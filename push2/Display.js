...
// command: 
//   0-3: Legacy display rows
//   -1 : Shutdown
Display.prototype.sendToDisplay = function (command, array)
{
    var data = [ -16, command ];    // -16 = 0xF0
